...
This work is based on several scientific works from past and present.

Our chosen architecture is inspired by several previous works.

A few of the referenced works are preprints.
Although this usually means that it is not peer reviewed.
Citing preprints is common practice nowadays.
All of the preprints we have used are well-cited and 
