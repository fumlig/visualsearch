...
Overall, it would seem like the spatial memory architeture is most suited where large search spaces have to be explored strategically, while our temporal memory architecture is sufficient for search problems where search spaces can be explored reactively.
...
The perspective we take with this work is that non-learning solution methods may offer these guarantees, but designing such solutions for every search problem is laborious.
