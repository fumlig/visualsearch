...
Real-world tasks have also been tackled with deep reinforcement learning.
...
We ask ourselves how an intelligent agent can be trained with reinforcement learning to search with these criterias in mind.
Specifically, we consider scenarious where the agent can only observe a small portion of its environment at any given time through a pan-tilt camera.
