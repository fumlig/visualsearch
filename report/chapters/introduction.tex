...
How humans and animals search for things has been extensively studied in neuroscience~\cite{eckstein_visual_2011,wolfe_visual_2010,wolfe_guided_2021}.

Automating visual search is of interest for several reasons.
Applications include search and rescue, outdoor and indoor building inspection, surveillance, and fire detection.
...
Several works have also successfully applied reinforcement learning to 
Among those 
Deep reinforcement learning could potentially be used to tackle the problem of searching for targets in new environments.
...
Specifically, we consider scenarios where the agent can only observe a small portion of its environment at any given time through a pan-tilt camera.
