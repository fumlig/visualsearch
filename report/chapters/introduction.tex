...
\begin{enumerate}
  ...
  \item How does the learning agent compare to random walk, exhaustive search, frontier-based search, a human searcher, and standard RL methods? % could be the same architecture but with LSTM, find some paper for this
