...
% ImageNet, deep learning revolution, Atari, Go

% should probably get into why this is hard to solve with "manual" algorithms
...
\begin{itemize}
  ...
  \item The agent should be able to find multiple targets while minimizing its path length. % test by comparing to optimal travel cost
  \item The agent should avoid looking at the same region twice. % test with revisit counters
\end{itemize}
