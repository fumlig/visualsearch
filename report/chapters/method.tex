...
Two deep RL approaches for solving the problem are presented.
Finally, we describe a set of experiments to evaluate our approaches.
...
To implement and evaluate agents that solve the problem, we use three different simulated environments.
All use the same observation space, action space and reward signal.
...
We use train our neural networks with PPO~\cite{schulman_proximal_2017}, as described in Section~\ref{sec:ppo}.
