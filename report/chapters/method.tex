...
However, we increase the learning rate for our approach.
This seems to be needed due to the increased number of parameters, which is in line with what is reported by \cite{andrychowicz_empirical_2020}.
The hyperparameters are presented in Table~\ref{tab:hyperparameters}.
