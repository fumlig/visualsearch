...
Ye et al.~\cite{ye_active_2018} propose an alternative architecture to \cite{zhu_target_2016}
which, in addition to an image of the camera view and the target object, uses the output of an object recognition module to select actions.
...
\todo{https://vision.cs.utexas.edu/projects/exploring-exploration/}
