...
DQN inspired many follow-up works\dots
% strategy
% model of reality
% just related things (not alphago etc)
...
We focus on literature in RL research.
...
\subsection{Inductive Bias and Generalization}
