...
The matrices \(w_i\), \(w_f\), \(w_o\) and \(w_c \in \mathbb{R}^{h \times (h+d)}\) are the weights for the input gate, forget gate, output gate, and cell respectively.
...
Policies wth higher entropy, or policies where action probabilities are closer to equal, can be favored by selecting a large coefficient \(c_2\).
