...
While covert attention tends to be reactionary, overt attention usually more strategic.
...
Finding an optimal solution in three dimensional search spaces has been shown to be NP-complete, necessitating approximate solutions~\cite{andreopoulos_theory_2009,ye_complexity-level_2001}.
...
Here, \(\mathcal{L}_\text{VF}\) is a squared-error loss betwen the value function approximation and the actual state value.
...
There have been several rigorous attempts to implement robotic object search systems using non-learning methods.
