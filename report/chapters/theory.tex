...
Here we recount the definition provided in \cite{kaelbling_pomdp_1998}. % todo: we currently don't use this definition
...
The goal of the agent is to maximize the expected \textit{discounted return} \(G_t \doteq \sum_{k=t+1}^{T}\gamma^{k-t-1}r_k\).
Here, \(\gamma\) represents the uncertainty of the environment.  
