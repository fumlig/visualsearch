...
Eye movement is \textit{saccadic} - rapid and almost instant between locations, at a constant cost.
This is not true for head movements, and in general not true for computer vision systems:
movements induced by motors tend to have a cost in time and energy that is proportional to the distance moved.
This means that such movements need to be more strategic.
...
While overt attention is hard attention, it is also interesting to take inspiration from soft attention, which more closely resembles covert attention.
