...
% introduce the policy and value function
% connect back to neural networks (or do that in deep reinforcement learning)
% cover action-value function? (Q-functions)
...
% include pseudocode
% clearly motivate which ones are good and bad
...
Dhiman et al. (2019)~\cite{dhiman_critical_2019} critically investigate deep RL for navigation\dots
