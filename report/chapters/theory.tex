...
\subsection{Sequential Visual Attention}
...
\todo{Many of these assume that objects are discrete and recognizable. What if there are colors or patterns instead?}
...
Specialized memory architectures, like ~\cite{}, can provide better performance for their intended tasks.
...
In their tests, their memory architecture performs better than LSTM layers  
...
\todo{Should maybe get into why procedural generation is and is not a good idea for RL.}
