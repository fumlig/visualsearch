...
More recently, the use of deep neural networks has shown tremendous success in RL.
In 2015, Mnih et al.~\cite{mnih_human_2015} extend \cite{mnih_atari_2013} and introduce DQN, which gives birth to the field of deep reinforcement learning (deep RL).
With a CNN architecture, DQN approximates the quality function \(q\) and select actions greedily using only visual input.
