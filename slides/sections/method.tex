...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                \item Previously applied successfully to tasks where memory is required~\cite{hausknecht_deep_2017,mnih_asynchronous_2016,mirowski_learning_2017,gupta_cognitive_2019}.
